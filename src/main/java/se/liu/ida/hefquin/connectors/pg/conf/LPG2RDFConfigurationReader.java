package se.liu.ida.hefquin.connectors.pg.conf;
...
import se.liu.ida.hefquin.connectors.pg.conf.impl.CompositeEdgeLabelMappingImpl;
import se.liu.ida.hefquin.connectors.pg.conf.impl.CompositeNodeLabelMappingImpl;
import se.liu.ida.hefquin.connectors.pg.conf.impl.CompositePropertyNameMappingImpl;
import se.liu.ida.hefquin.connectors.pg.conf.impl.EdgeLabelMapping;
import se.liu.ida.hefquin.connectors.pg.conf.impl.EdgeLabelMappingImpl_AllToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.EdgeLabelMappingImpl_RegexMatchToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.EdgeLabelMappingImpl_SingleMatchToURI;
import se.liu.ida.hefquin.connectors.pg.conf.impl.LPG2RDFConfigurationImpl;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMapping;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMappingImpl_AllToLiterals;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMappingImpl_AllToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMappingImpl_RegexMatchToLiterals;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMappingImpl_RegexMatchToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMappingImpl_SingleMatchToLiteral;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeLabelMappingImpl_SingleMatchToURI;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeMapping;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeMappingImpl_AllToBNodes;
import se.liu.ida.hefquin.connectors.pg.conf.impl.NodeMappingImpl_AllToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.PropertyNameMapping;
import se.liu.ida.hefquin.connectors.pg.conf.impl.PropertyNameMappingImpl_AllToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.PropertyNameMappingImpl_RegexMatchToURIs;
import se.liu.ida.hefquin.connectors.pg.conf.impl.PropertyNameMappingImpl_SingleMatchToURI;
import se.liu.ida.hefquin.connectors.pg.conf.vocabulary.LPGtoRDF;
